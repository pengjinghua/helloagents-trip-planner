    ...
    <a-card class="form-card" :bordered="false">
      ...
      >
        ...
        <div class="form-section">
          <div class="section-header">
            <span class="section-icon">📚</span>
            <span class="section-title">知识库导入(可选)</span>
          </div>

          <a-tabs v-model:activeKey="kbActiveTab">
            <a-tab-pane key="text" tab="文本">
              <a-form-item>
                <template #label>
                  <span class="form-label">标题(可选)</span>
                </template>
                <a-input v-model:value="kbTextTitle" placeholder="例如: 我的北京攻略" size="large" class="custom-input" />
              </a-form-item>
              <a-form-item>
                <template #label>
                ...
                <a-textarea
                  ...
                  placeholder="粘贴你希望AI参考的内容(开放时间/预约方式/必去清单/差旅制度等)…"
                  :rows="5"
                  size="large"
                  class="custom-textarea"
                />
              </a-form-item>
              <a-button type="default" :loading="kbLoading" @click="handleIngestText">导入文本</a-button>
            </a-tab-pane>
            ...
            <a-tab-pane key="url" tab="URL">
              <a-form-item>
                ...
                <a-input v-model:value="kbUrlTitle" placeholder="例如: 某攻略页" size="large" class="custom-input" />
              </a-form-item>
              <a-form-item>
                <template #label>
                  <span class="form-label">链接</span>
                </template>
                <a-input v-model:value="kbUrl" placeholder="https://..." size="large" class="custom-input" />
              </a-form-item>
              <a-button type="default" :loading="kbLoading" @click="handleIngestUrl">导入链接</a-button>
            </a-tab-pane>
            ...
            <a-tab-pane key="file" tab="文件">
              <a-form-item>
                ...
                <a-input v-model:value="kbFileTitle" placeholder="留空则使用文件名" size="large" class="custom-input" />
              </a-form-item>
              <a-form-item>
                <template #label>
              ...
              <a-button type="default" :loading="kbLoading" @click="handleIngestFile">导入文件</a-button>
            </a-tab-pane>
          </a-tabs>
...
import { generateTripPlan, ingestRagText, ingestRagUrl, ingestRagFile } from '@/services/api'
